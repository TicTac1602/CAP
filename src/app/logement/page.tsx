...
export default function LogementPage() {
  const theme = getThemeById('logement');
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div id="guides" className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-6">
                  {theme.guides.map((guide) => (
                    <div key={guide.id} className="border-l-4 border-green-500 pl-4">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="/administration" className="p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
              <div className="flex items-center">
                <span className="text-2xl mr-3">📋</span>
                <div>
                  <h3 className="font-semibold">Administration</h3>
                  <p className="text-sm text-gray-600">Impôts, papiers, sécurité sociale</p>
                </div>
              </div>
            </a>
